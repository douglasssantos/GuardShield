 ...
 * @method static Role getRoleById(int $roleId, bool $withPermissions = false)
 * @method static Module getModuleById(int $moduleId, bool $withPermissions = false)
 * @method static Permission getPermissionById(int $permissionId)
